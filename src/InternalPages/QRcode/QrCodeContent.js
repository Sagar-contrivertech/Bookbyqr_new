                            ...
                            <Grid container justify="center">
                                <div _ngcontent-serverapp-c139 className="text-center print-qa-css">
                                    ...
                                    <p _ngcontent-serverapp-c139 className="thank-you-psg mb-0"> To make a appointment <br _ngcontent-serverapp-c139 /> Please Scan the QR Code </p><div _ngcontent-serverapp-c139 className="qrcode">
                                        <img _ngcontent-serverapp-c139 width={256} height={256} className="my-2" src="https://bookbyqr.com/api/book-by-qr/storage/app/qr_code/uJYHAB6mYxnMx2bSharableCode124.png" /></div><p _ngcontent-serverapp-c139 className="thank-you-psg"> By Scanning the QR, <br /> you accept terms of service available at the Merchant </p>
